...

{
	...
	private int radius; // radius of the square
	private Color color; // color of the circle
	static Random generator = new Random();

	// ---------------------------------------------------------
	// Creates a random square with properties in ranges given:
	// -- radius 25..74
	...
	// ----------------------------------------------------------
	// Creates a square of a given size (diameter). Other
	...
	// ---------------------------------------------------------
	// Draws a square on graphics object given
	// ---------------------------------------------------------

	public void draw(Graphics page)
	{
		page.setColor(color);
		page.fillRect(x, y, radius * 2, radius * 2);
	}
	// --------------------------------------------------------
